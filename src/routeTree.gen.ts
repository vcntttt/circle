...
const OrgIdIssuesIssueIdentifierRoute = OrgIdIssuesIssueIdentifierRouteImport.update({
   id: '/$issueIdentifier',
   path: '/$issueIdentifier',
...
const OrgIdIssuesRouteWithChildren = OrgIdIssuesRoute._addFileChildren(OrgIdIssuesRouteChildren);
